...
<head>
    ...
    <link rel="shortcut icon" href="images/clever.png">
...
<div id="head-nav" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand"><span class="font-dosis">My Application</span></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                <li class="dropdown profile_menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding-top: 15px;">
                        <img alt="Avatar" src="images/user.png"/>Jeff Hanneman <b class="caret"></b>
                    </a>
            ...
            <div class="menu-space">
                <div class="content">
                    <ul class="cl-vnavigation">
                        <li>
                            <a href="pagina.html" class="btn-menu"><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
                        </li>
                        <li><a href="#"><i class="fa fa-list"></i><span>Datos</span></a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="puestos.php" class="btn-menu" data-menu="Datos" data-submenu="Puestos de Trabajo">
                                        Puestos de Trabajo
                                    </a>
                                </li>
                                <li class="active"><a href="tablas.html">Clientes</a></li>
                                <li><a href="tables-datatables.html">Proveedores</a></li>
                                <li><a href="form-elements.html">Trabajadores</a></li>                                
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="#">Pagos de Clientes</a></li>
