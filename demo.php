                    ...
                    <ul class="cl-vnavigation">
                        ...
                        <li><a href="#"><i class="fa fa-list"></i><span>Datos</span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="tablas.html">Comentarios de Art&iacute;culos</a></li>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        //Agregamos el boton nuevo registro
        var botonNuevo = '<a href="mi-ruta.html" class="btn btn-default" id="btn-nuevo-registro"><i class="fa fa-plus-circle"></i><span>Nuevo Registro</span></a>&nbsp;&nbsp;';
        var filtro = $('#datatable_filter').html();
        $('#datatable_filter').html(botonNuevo + filtro);
        */
